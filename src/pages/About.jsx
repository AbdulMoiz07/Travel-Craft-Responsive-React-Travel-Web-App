...
import { Heart, Globe, Users, Award, Zap, Shield, User } from 'lucide-react';
import pic1 from './pic1.jpg'; //image
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {team.map((member, index) => (
              ...
              >
                <div className="w-full h-64 bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center overflow-hidden">
                  {member.image && !imageErrors[member.name] ? (
                    <img
                      src={member.image}
                      alt={member.name}
                      className={`w-full h-full object-cover ${
                        member.name === 'Mobeen Zaheer' ? 'object-[center_20%]' : 
                        member.name === 'Abdul Moiz' ? 'object-[center_30%]' : 
                        member.name === 'Husnain Ali' ? 'object-[center_10%]' :
                        'object-center'
                      }`}
